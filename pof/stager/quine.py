...
Todo:
- add opttion to keep the source code, and simply add the quine function
...
- have another way to store the base64 code, for example in the comments using
  the other stagers. Or even have the original code still present, and hide the
